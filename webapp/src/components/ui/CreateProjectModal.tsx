    ...
    return (
        <div className="flex flex-col absolute justify-center items-center top-0 left-0  w-full h-full bg-black/40 ">
            <div className="flex flex-col absolute justify-center items-center max-w-lg gap-4 p-6 rounded-md shadow-md sm:py-8 sm:px-12 dark:bg-gray-900 bg-white dark:text-gray-100">
                ...
                <h2 className='text-violet-700 dark:text-white my-3 text-lg'>New Project</h2>
                ...
                <button type="button" className="flex flex-row shadow items-center space-x-2 px-8 py-3 font-semibold rounded-full shadow hover:bg-violet-700 hover:text-white dark:bg-violet-700 dark:text-gray-900 transition ease-linear" onClick={handleSaveProject} ><FiSave /> Save</button>
            </div>
        </div>
    );
}
